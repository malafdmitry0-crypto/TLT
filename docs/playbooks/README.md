...
| [heatcalc-table-column-layout-prompt.md](heatcalc-table-column-layout-prompt.md) | Расширить `Поля таблицы`: порядок колонок, drag-and-drop и сохранение ширины |
