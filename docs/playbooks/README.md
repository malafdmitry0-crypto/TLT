...
| [god-components-safe-split-nightly-prompt.md](god-components-safe-split-nightly-prompt.md) | Ночной agent prompt для анализа и безопасного refactor slice HeatCalcPage |
| [eleccalc-safe-split-nightly-prompt.md](eleccalc-safe-split-nightly-prompt.md) | Ночной agent prompt для анализа и безопасного refactor slice ElecCalcPage |
| [eleccalc-page-decomposition-prompts.md](eleccalc-page-decomposition-prompts.md) | Roadmap и progress ledger декомпозиции ElecCalcPage |
...
| [heatcalc-table-column-layout-prompt.md](heatcalc-table-column-layout-prompt.md) | Расширить `Настройки таблицы`: порядок колонок, drag-and-drop и сохранение ширины |
