...
«Другое» с λ и температурным диапазоном), резервуар (цилиндрическая и прямоугольная формы,
частичное заглубление, `q_additional`), климат/грунты/режимы tm с provenance.
