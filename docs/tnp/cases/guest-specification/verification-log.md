...
> [!WARNING]
> Датированный журнал исходного аудита до реализации последующих фаз. Его
> FAIL/PARTIAL-статусы не являются текущим статусом; использовать актуальные
> phase checkpoints и `phase-5-checkpoint.md`.
...
- Целевой TTL три дня утверждён PDL-ER-26; действующая реализация и guest SRS
  всё ещё используют 20 минут, поэтому это implementation/documentation drift.
