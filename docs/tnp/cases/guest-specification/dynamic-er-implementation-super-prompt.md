...
> [!WARNING]
> Исторический implementation prompt, подготовленный до реализации Phase 1–5.
> Не запускать его как текущую задачу целиком. Актуальный статус и остаточные
> gaps находятся в `phase-5-checkpoint.md` и
> `../../../architecture/dynamic-electrical-variants.md`.
