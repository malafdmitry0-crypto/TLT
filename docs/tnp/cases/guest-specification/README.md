...
Phase 5 checkpoint (`phase-5-checkpoint.md`): guest full BOM, multi-ЭР generate, d≥57, guest TTL 3d defaults, CSV v3, report UUID-first — **partial PASS**. Phase 4 blocked PDL-ER-15/18/28. PDL-ER-27 (500 objects) and ER5 write cutover remain open.
