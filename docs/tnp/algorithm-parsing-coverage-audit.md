...
`p3=min(Imax²*Rм, optional max_linear_power_w_m)`, `L1/L2` — длина секции с
учетом укладки. Табличные thermal-limit коэффициенты могут приходить из БД; до
их заполнения fallback — лимит тока `65 А`.
