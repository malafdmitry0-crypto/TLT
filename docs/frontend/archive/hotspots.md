...
> Архивный snapshot. Не использовать LOC и приоритеты без повторного измерения.
...
| Место | ~LOC | Почему |
|---|---:|---|
| `pages/ElecCalcPage.tsx` | 1787 | ЭР UUID, assignments, batch, candidates, tables, modals |
