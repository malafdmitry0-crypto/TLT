    ...
    return [
        ...
        *(
        ...
        FieldDef(
            ...
            "Глубина заложения" if object_type == "pipe" else "Высота заглублённой части",
...
PIPE_FIELDS: tuple[FieldDef, ...] = (
    *_common_fields("pipe")[:4],
    FieldDef(
        ...
        ("pipe",),
        "number",
        _result("heat_loss_per_meter_base"),
        unit="W/m",
        filter_ops=("range",),
        sortable=True,
        sort_type="number",
    ...
    FieldDef(
        ...
        ("pipe",),
        "number",
        _result("total_heat_loss_design"),
        unit="W",
        filter_ops=("range",),
        sortable=True,
        sort_type="number",
...
TANK_FIELDS: tuple[FieldDef, ...] = (
    *_common_fields("tank")[:4],
    FieldDef(
        ...
        ("tank",),
        "number",
        _result("heat_loss_per_m2_bare_base"),
        unit="W/m²",
        filter_ops=("range",),
        sortable=True,
        sort_type="number",
...
OBJECT_SQL_EXPRESSIONS: dict[str, SqlExprFactory] = {
    ...
    "placement": lambda: _sql_param_text("placement"),
    "insulation_layer_count": _sql_insulation_layer_count,
    "insulation_thickness": lambda: _sql_layer_mm(0, "thickness"),
    "insulation_material": lambda: _sql_layer_text(0, "material"),
    ...
    "tank_buried_height": lambda: _sql_param_number("tank_buried_height"),
    ...
    "heat_loss_per_meter_base": lambda: _sql_result_number("heat_loss_per_meter_base"),
    "heat_loss_per_m2_bare_base": lambda: _sql_result_number("heat_loss_per_m2_bare_base"),
    "total_heat_loss_design": lambda: _sql_result_number("total_heat_loss_design"),
