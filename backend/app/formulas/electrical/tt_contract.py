...
ELECTRICAL_TT_FORMULA_VERSION = "electrical-tt-v3-case1-r4"

_FORMULA_CONTRACT = (
    "case1-r4;P_req=q*K;P_cable=nominal_power;all-full-mark-candidates;"
    "T_product<=T_max;T_env>=T_min;manual-missing-N=1;"
    "sort=N,P_cable,P_cable*N,full_mark;user-U-downstream;"
    "winding-pitch;equal-sections;Lfact-totals;order=ceil(Lfact*1.10,0.001)"
)
