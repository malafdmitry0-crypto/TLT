  ...
  return (
    ...
    >
      {errorMsg ? (
          ...
          description={
            <>
              ...
              >
                ...
                но не укладывается в линейку ТЛТ на этапе электрорасчёта.
                В текущей поставке есть расчётная формула и каталог только для
                саморегулирующегося кабеля ТЛТ: мощность <strong>10–100 Вт/м</strong>,
                T_продукта до{' '}
                <strong>150°C</strong>, T_среды от <strong>−60°C</strong>.
                Для объектов вне этих диапазонов нужны резистивные кабели /
                кабели с минеральной изоляцией / скин-системы; для них нужны
                отдельные формулы и каталоги.
              </Text>
        ...
        <Text type="secondary">
          {obj.is_valid
            ? 'Нажмите «Выполнить электрорасчёт» чтобы подобрать кабель'
