          ...
          description={
            <>
              ...
              >
                ...
                В MVP поддерживается только саморегулирующийся кабель ТЛТ:
                мощность <strong>10–100 Вт/м</strong>, T_продукта до{' '}
                <strong>150°C</strong>, T_среды от <strong>−60°C</strong>.
                Для объектов вне этих диапазонов нужны резистивные кабели /
                кабели с минеральной изоляцией / скин-системы — они появятся
                в «Полной версии» (US-09.7 / 09.8 / 09.9).
              </Text>
