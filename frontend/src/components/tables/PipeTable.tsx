...
export default function PipeTable({ data, projectId, onEdit, onReorder }: Props) {
  ...
  return (
    ...
    <CalcTable<ProjectObject>
      ...
      locale={{
        emptyText: (
          <Text type="secondary">
            Трубопроводы не добавлены. Используйте кнопку «Добавить трубопровод».
          </Text>
        ),
      }}
      columns={[
        ...
        {
          title: 'Ø, мм',
          dataIndex: ['params', 'outer_diameter'],
          width: 70,
        ...
        },
        {
          ...
          render: (_: unknown, r: ProjectObject) => (
            <ResultCell
              value={formatNumber(Number(r.results?.heat_loss_per_meter), 1)}
              obj={r}
            />
          ),
        },
