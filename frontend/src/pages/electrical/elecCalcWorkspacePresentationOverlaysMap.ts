...
export function mapOverlaysToPresentation(source: OverlaysPresentationSource) {
  ...
  return {
    ...
    cableMarkModalThreadCountValue: modals.cableMarkModal.threadCountValue,
    cableMarkModalOptions: modals.cableMarkModal.options,
    cableMarkModalAutoAvailability: modals.cableMarkModal.autoAvailability,
    retryCableMarkModalAutoAvailability: modals.cableMarkModal.retryAutoAvailability,
    changeCableMarkModalCableType: modals.cableMarkModal.changeCableType,
    setCableMarkModalValue: modals.cableMarkModal.setValue,
    setCableMarkModalThreadCountValue: modals.cableMarkModal.setThreadCountValue,
