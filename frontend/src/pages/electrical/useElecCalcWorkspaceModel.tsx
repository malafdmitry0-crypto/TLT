...
export function useElecCalcWorkspaceModel({
  ...
  const cableTypeOptionsState = useElecCalcCableTypeOptions({
    ...
    resetConnectionType: () => setRecalc.connectionType('line_1ph'),
      ...
      return useElecCalcWorkspacePresentationAssembly(mapWorkspaceToPresentation({ data, project, canMutate, projectId, electricalVariant, onAssignmentsChanged, activateRowId, summary, columnPersistence, cableTypeOptionsState, mainTable, electricalGlideEnabled, electricalVariantName, navigate, columnDraft, overwriteManualChoices, paramsPanelVisible, recalc, setRecalc, resetColumnFilter, resetCurrentTableViewState, resolvedTableFontSize, setColumnFilter, setElectricalTableSort, setOverwriteManualChoices, setSystemView, systemView, tableDragging, setTableDragging, tableScrollRegionsRef, tableViewState, toggleParamsPanel, cableMarkModal, cableSizingModal, candidate, cableMarkPresentation, candidateWorkflow, candidateTableViewState, candidateTableViewActive, objectActionModals, resetCandidateTableViewState, setCandidateColumnFilter, resetCandidateColumnFilter, setCandidateTableSort, candidateColumnSettingsOpen, setCandidateColumnSettingsOpen, normalizedTableViewSettings, updateCandidateTableColumnPreference, columnSettingsOpen, setColumnSettingsOpen, updateTableColumnPreference, updateTableSettingsPreference, currentTableViewActive, cableSelection, commercialFeaturesAvailable, isEmployee, visibleCandidateColumnMetas }));
}
