    ...
    <div style={{ minHeight: '100vh', background: '#f5f5f5', padding: '40px 24px' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        ...
        <Card>
          ...
          <Steps
            ...
            items={[
              ...
              },
              {
                ...
                description: 'В разделе «База данных» убедитесь, что справочники (климат, материалы, кабели, аксессуары) загружены. В MVP справочники встроены в образ и не редактируются через UI.',
                status: 'process',
              },
              {
          ...
          <Paragraph>
            <ul>
              <li>Администратор <Text strong>не может</Text> выполнять расчёты и просматривать проекты сотрудников</li>
