        ...
        <Card>
          ...
          <ul>
            ...
            <li>
              ...
              В текущей поставке расчётная формула и каталог есть для ТЛТ; для резистивных кабелей, кабелей с минеральной изоляцией и скин-систем нужны отдельные формулы и каталоги.
            </li>
          </ul>
          <Paragraph type="secondary" style={{ fontSize: 13 }}>
