...
export default function EmployeeHelpPage() {
  ...
  const accessData = [
    ...
    { key: 2, feature: 'Электрорасчёт ТЛТ (автоподбор кабеля)', access: true },
      ...
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        ...
        <Card>
          ...
          <Steps
            ...
            items={[
              ...
              },
              {
                ...
                description: 'Кнопка «Электрорасчёт →» в правом верхнем углу таблицы запустит пакетный автоподбор ТЛТ для всех валидных объектов. Если кабель не подобрался — в карточке объекта появится красный блок с причиной (превышен лимит 100 Вт/м, температура вне диапазона и т.п.).',
                icon: <CalculatorOutlined />,
                status: 'process',
              },
              {
          ...
          <ul>
            ...
            <li>
              <Text strong>Этап 2</Text> — применимость <strong>линейки ТЛТ</strong> (10…100 Вт/м, T_max до 150°C, T_min от −60°C) к рассчитанной теплопотере. Если этап упал — объект физически валиден, но выходит за рамки встроенной линейки.
              По ТЗ §4.2.2 в MVP поддерживается только ТЛТ; резистивные кабели, кабели с минеральной изоляцией и скин-системы — «Полная версия» (US-09.7/09.8/09.9 в бэклоге).
            </li>
          </ul>
          <Paragraph type="secondary" style={{ fontSize: 13 }}>
            Что делать с ошибкой этапа 2: попробовать выбрать кабель вручную через селектор, снизить теплопотери (увеличить толщину изоляции, разбить длинную трубу на участки) или принять как ограничение MVP.
          </Paragraph>
