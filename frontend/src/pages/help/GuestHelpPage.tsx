        ...
        <Card>
          ...
          <Paragraph>
            <ul>
              ...
              <li><Text strong>Длина</Text> — в метрах (от 0,01 до 200 000)</li>
          ...
          <Paragraph>
            <ul>
              ...
              <li>
                ...
                Это <em>не ошибка</em>, а ограничение MVP: для очень мощных / очень горячих / очень холодных случаев нужны другие типы кабелей (резистивные, MI, скин-системы) — они появятся в «Полной версии».
