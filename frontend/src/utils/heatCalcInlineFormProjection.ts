...
const PIPE_FORM_PROJECTION_KEYS = [
  ...
  'ambient_temperature', 'max_ambient_temperature', 'process_temperature', 'max_process_temperature',
  ...
  'ground_conductivity_source', 'wind_speed', 'climate_city', 'climate_region',
...
const TANK_FORM_PROJECTION_KEYS = [
  ...
  'wind_speed', 'climate_city', 'climate_region',
  'climate_key', 'climate_temperature_basis', 'insulation_temperature_basis', 'ambient_temperature_source',
