/**
 * Heat-calc table column catalog, width helpers, and settings normalization.
 */
import {
...
export function defaultColumnWidthPct(column: HeatCalcColumnMeta) {
...
export function defaultTypeSettings(type: HeatCalcTableColumnScope): HeatCalcTableColumnTypeSettings {
...
export function normalizeVisibleOrder(
