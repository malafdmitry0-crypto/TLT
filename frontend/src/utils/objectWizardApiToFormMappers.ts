...
export function pipeApiParamsToForm(p: Record<string, unknown>): Partial<PipeFormValues & { name: string }> {
  ...
  return {
    ...
    explosion_zone_type: p.explosion_zone_type as PipeFormValues['explosion_zone_type'],
    power_indication_on_boxes: p.power_indication_on_boxes as PipeFormValues['power_indication_on_boxes'],
    end_of_section_indication: p.end_of_section_indication as PipeFormValues['end_of_section_indication'],
...
export function tankApiParamsToForm(p: Record<string, unknown>): Partial<TankFormValues & { name: string }> {
  ...
  return {
    ...
    winding_coefficient: p.winding_coefficient as number | undefined,
    connection_type: p.connection_type as string | undefined,
    explosion_zone_type: p.explosion_zone_type as TankFormValues['explosion_zone_type'],
    power_indication_on_boxes: p.power_indication_on_boxes as TankFormValues['power_indication_on_boxes'],
    end_of_section_indication: p.end_of_section_indication as TankFormValues['end_of_section_indication'],
    top_of_box_indication: p.top_of_box_indication as TankFormValues['top_of_box_indication'],
    min_length_for_k2i: p.min_length_for_k2i as number | undefined,
    hot_reserve_coefficient: p.hot_reserve_coefficient as number | undefined,
