import type { CableSource, CableType } from '@/api/calculations';
...
export const referenceQueryKeys = {
  ...
  cables: (source: CableSource, cableType: CableType) =>
    ['references', 'cables', source, cableType, 'type-filtered'] as const,
