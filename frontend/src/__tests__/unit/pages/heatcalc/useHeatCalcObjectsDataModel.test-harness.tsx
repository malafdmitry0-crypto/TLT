/* eslint-disable @typescript-eslint/no-unused-vars -- mock harness re-exports fixtures */
/**
 * Shared harness for useHeatCalcObjectsDataModel scenario tests.
 * Import this module first (vi.mock), then helpers.
 */
...
export function meta(key: string): HeatCalcResolvedColumnMeta {
  return {
    key,
