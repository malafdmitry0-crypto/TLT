/**
 * Shared harness for ObjectWizard scenario integration tests.
 * No test registration — import from ObjectWizard.*.test.tsx only.
 *
 * Note: vi.mock('@/api/references') must live in each *.test.tsx (Vitest hoist),
 * not only here.
 */
